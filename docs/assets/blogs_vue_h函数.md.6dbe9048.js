import{d as i,j as u,a6 as h,a7 as t,o as r,c as E,_ as C,h as _,a as l,t as A,p as v,m as g,k as s,C as D,b,w as p,e as x,l as B,H as c,Q as f}from"./chunks/framework.f805e0a2.js";import{B as k,A as S,a as y}from"./chunks/index.79b2ff0f.js";import{m}from"./chunks/mock.93bc3284.js";import"./chunks/commonjsHelpers.725317a4.js";const M={id:"ele"},V=i({__name:"h函数.md.demo.17e71582",setup(a){u(()=>{o()});const o=()=>{const e=document.createElement("div");document.querySelector("#ele").appendChild(e),h(t("div",{innerHTML:"h函数666",style:{color:"red"},class:"test"}),e)};return(e,n)=>(r(),E("div",M))}});const w=C(V,[["__scopeId","data-v-ab11e976"]]),T={id:"com"},I=i({__name:"h函数.md.demo.17e71583",setup(a){u(()=>{o()});const o=()=>{const e=document.createElement("div");document.querySelector("#com").appendChild(e),h(t(k,{innerHTML:"按钮",onClick:()=>{alert("按钮点击了")}}),e)};return(e,n)=>(r(),E("div",T))}});const q=C(I,[["__scopeId","data-v-63b96537"]]),N=a=>(v("data-v-0a72e276"),a=a(),g(),a),P=N(()=>s("div",{id:"vmodel"},null,-1)),H=i({__name:"h函数.md.demo.17e71584",setup(a){u(()=>{e()});const o=_(!1),e=()=>{const n=document.createElement("div");document.querySelector("#vmodel").appendChild(n),h(t(S,{checked:o,"onUpdate:checked":F=>{o.value=F}}),n)};return(n,d)=>(r(),E("div",null,[l(A(o.value)+" ",1),P]))}});const L=C(H,[["__scopeId","data-v-0a72e276"]]),$=Array.from({length:50},()=>({name:m.mock("@cname"),age:m.Random.integer(8,12),score:m.Random.integer(55,95)})),R=[{title:"Name",dataIndex:"name"},{title:"Age",dataIndex:"age"},{title:"Score",dataIndex:"score"},{title:"Tag",dataIndex:"tag",customRender:a=>{console.log(a);const o=a.record.score;return o>=90?t(y,{innerText:"优",color:"#108EE9"}):o>=80&&o<90?t(y,{innerText:"良",color:"#2DB7F5"}):o<80&&o>=60?t(y,{innerText:"中",color:"#87D068"}):t(y,{innerText:"差",color:"#FF5500"})}}],j={key:0},U=i({__name:"h函数.md.demo.17e71585",setup(a){return(o,e)=>{const n=D("a-table");return r(),b(n,{columns:B(R),"data-source":B($)},{bodyCell:p(({column:d,text:F,record:Z})=>[d.dataIndex==="name"?(r(),E("a",j,A(F),1)):x("",!0)]),_:1},8,["columns","data-source"])}}}),O=f(`<h2 id="定义" tabindex="-1">定义 <a class="header-anchor" href="#定义" aria-label="Permalink to &quot;定义&quot;">​</a></h2><p>创建虚拟 DOM 节点 (vnode)。</p><h2 id="类型" tabindex="-1">类型 <a class="header-anchor" href="#类型" aria-label="Permalink to &quot;类型&quot;">​</a></h2><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 完整参数签名</span></span>
...
<span class="line"><span style="color:#D73A49;">type</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">Slot</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">=</span><span style="color:#24292E;"> () </span><span style="color:#D73A49;">=&gt;</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">Children</span><span style="color:#24292E;">;</span></span>
<span class="line"><span style="color:#D73A49;">type</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">Slots</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">=</span><span style="color:#24292E;"> { [</span><span style="color:#E36209;">name</span><span style="color:#D73A49;">:</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">string</span><span style="color:#24292E;">]</span><span style="color:#D73A49;">:</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">Slot</span><span style="color:#24292E;"> };</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><h2 id="渲染原生-dom" tabindex="-1">渲染原生 dom <a class="header-anchor" href="#渲染原生-dom" aria-label="Permalink to &quot;渲染原生 dom&quot;">​</a></h2>`,5),J=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"  }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}},">")])])])],-1),Q=s("h2",{id:"渲染组件",tabindex:"-1"},[l("渲染组件 "),s("a",{class:"header-anchor",href:"#渲染组件","aria-label":'Permalink to "渲染组件"'},"​")],-1),z=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"  }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}},">")])])])],-1),G=s("h2",{id:"h-函数中的-双向数据绑定",tabindex:"-1"},[l("h 函数中的 双向数据绑定 "),s("a",{class:"header-anchor",href:"#h-函数中的-双向数据绑定","aria-label":'Permalink to "h 函数中的 双向数据绑定"'},"​")],-1),K=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"  }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}},">")])])])],-1),W=s("h2",{id:"使用场景-ant-design-表格自定义渲染为例",tabindex:"-1"},[l("使用场景(ant design 表格自定义渲染为例) "),s("a",{class:"header-anchor",href:"#使用场景-ant-design-表格自定义渲染为例","aria-label":'Permalink to "使用场景(ant design 表格自定义渲染为例)"'},"​")],-1),X=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),as=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"blogs/vue/h函数.md","filePath":"blogs/vue/h函数.md"}'),Y={name:"blogs/vue/h函数.md"},es=Object.assign(Y,{setup(a){return(o,e)=>{const n=D("demo");return r(),E("div",null,[O,c(n,{customClass:"",sourceCode:`<template>
  <div id="ele"></div>
</template>
...
`},{highlight:p(()=>[J]),default:p(()=>[c(w)]),_:1}),Q,c(n,{customClass:"",sourceCode:`<template>
  <div id="com"></div>
</template>
...
`},{highlight:p(()=>[z]),default:p(()=>[c(q)]),_:1}),G,c(n,{customClass:"",sourceCode:`<template>
  <div>
    {{ switchValue }}
    <div id="vmodel"></div>
  </div>
...
`},{highlight:p(()=>[K]),default:p(()=>[c(L)]),_:1}),W,c(n,{customClass:"",sourceCode:`<template>
...
<\/script>
`},{highlight:p(()=>[X]),default:p(()=>[c(U)]),_:1})])}}});export{as as __pageData,es as default};
