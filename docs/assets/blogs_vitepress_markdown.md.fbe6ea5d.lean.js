...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"  }")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}},">")])])])],-1),j=c("",2),R=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"blogs/vitepress/markdown.md","filePath":"blogs/vitepress/markdown.md"}'),I={name:"blogs/vitepress/markdown.md"},N=Object.assign(I,{setup(r){return(e,a)=>{const l=i("a-button"),y=i("demo"),m=i("git-talk");return o(),t("div",null,[T,p(q),w,p(l,null,{default:E(()=>[n("这是一个按钮")]),_:1}),P,p(y,{customClass:"",sourceCode:`<template>
...
`},{highlight:E(()=>[S]),default:E(()=>[p(_)]),_:1}),j,p(m)])}}});export{R as __pageData,N as default};
