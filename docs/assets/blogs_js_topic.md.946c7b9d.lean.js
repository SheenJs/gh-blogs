...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"  }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}},">")])])])],-1),K=A("",2),G=JSON.parse('{"title":"刷刷面试题","description":"","frontmatter":{},"headers":[],"relativePath":"blogs/js/topic.md","filePath":"blogs/js/topic.md"}'),J={name:"blogs/js/topic.md"},Z=Object.assign(J,{setup(F){return(e,a)=>{const o=d("demo");return y(),i("div",null,[U,p(o,{customClass:"",sourceCode:`<template></template>
<script setup>
