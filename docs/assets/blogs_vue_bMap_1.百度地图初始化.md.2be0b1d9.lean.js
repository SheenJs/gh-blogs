import{l as d}from"./chunks/map.965815c3.js";import{d as m,h as u,j as b,o as E,c as y,_ as C,C as t,H as p,w as r,Q as B,k as s,a as l}from"./chunks/framework.bec6ef87.js";const A=m({__name:"1.百度地图初始化.md.demo.11d6a0f7",setup(i){const o=u();b(async()=>{await e(o.value)});async function e(a){const n=await d(),c=new n.Map(a,{enableDblclickZoom:!0,enableMapClick:!1,displayOptions:{building:!1},enableRotate:!1,enableTilt:!1}),F=new n.Point(99.657606,27.302755);c.centerAndZoom(F,18),c.enableScrollWheelZoom(!0)}return(a,n)=>(E(),y("div",{id:"container",class:"container",ref_key:"container",ref:o},null,512))}});const _=C(A,[["__scopeId","data-v-83a24bb3"]]),D=B("",4),f=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"  }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}},">")])])])],-1),v=JSON.parse('{"title":"初始化","description":"","frontmatter":{},"headers":[],"relativePath":"blogs/vue/bMap/1.百度地图初始化.md","filePath":"blogs/vue/bMap/1.百度地图初始化.md"}'),M={name:"blogs/vue/bMap/1.百度地图初始化.md"},L=Object.assign(M,{setup(i){return(o,e)=>{const a=t("demo"),n=t("git-talk");return E(),y("div",null,[D,p(a,{customClass:"",sourceCode:`<template>
...
`},{highlight:r(()=>[f]),default:r(()=>[p(_)]),_:1}),p(n)])}}});export{v as __pageData,L as default};
