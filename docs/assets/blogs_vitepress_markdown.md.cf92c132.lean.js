import{u as h}from"./chunks/useECharts.5587d214.js";import{d,h as b,j as F,o,c as t,_ as u,a1 as v,g,k as s,C as i,H as p,w as E,Q as c,a as n}from"./chunks/framework.f805e0a2.js";const C="/gh-blogs/logo.webp",k=d({__name:"markdown.md.demo.e5e3f566",setup(r){const e=b();return F(()=>{h(e.value,{title:{text:"柱形图"},xAxis:{data:["衬衫","羊毛衫","雪纺衫","裤子","高跟鞋","袜子"]},yAxis:{},series:{name:"销量",type:"bar",data:[5,20,36,10,10,20]}})}),(a,l)=>(o(),t("div",{class:"container",ref_key:"charRef",ref:e},null,512))}});const _=u(k,[["__scopeId","data-v-29e5f51b"]]),B={class:"svg-loader"},f=["height","width"],A=["cx","cy","r"],D=["cx","cy","r"],x=d({__name:"SvgLoading",props:{size:{default:20}},setup(r){const e=r;v(l=>({"2674653d":a.value/10}));const a=g(()=>e.size/2);return(l,y)=>(o(),t("div",B,[(o(),t("svg",{height:l.size,width:l.size,class:"svg-container"},[s("circle",{cx:a.value,cy:a.value,r:a.value-a.value/10,class:"loader-svg bg"},null,8,A),s("circle",{cx:a.value,cy:a.value,r:a.value-a.value/10,class:"loader-svg animate"},null,8,D)],8,f))]))}});const q=u(x,[["__scopeId","data-v-8456ed6c"]]),T=c("",35),w=c("",6),P=c("",6),S=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"  }")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}},">")])])])],-1),j=c("",2),N=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"blogs/vitepress/markdown.md","filePath":"blogs/vitepress/markdown.md"}'),L={name:"blogs/vitepress/markdown.md"},V=Object.assign(L,{setup(r){return(e,a)=>{const l=i("a-button"),y=i("demo"),m=i("git-talk");return o(),t("div",null,[T,p(q),w,p(l,null,{default:E(()=>[n("这是一个按钮")]),_:1}),P,p(y,{customClass:"",sourceCode:`<template>
