...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1),z=JSON.parse('{"title":"控件","description":"","frontmatter":{},"headers":[],"relativePath":"blogs/vue/bMap/3.控件.md","filePath":"blogs/vue/bMap/3.控件.md"}'),G={name:"blogs/vue/bMap/3.控件.md"},N=Object.assign(G,{setup(f){return(e,E)=>{const p=A("demo"),k=A("git-talk");return D(),m("div",null,[Z,o(p,{customClass:"",sourceCode:`<template>
...
`},{highlight:B(()=>[O]),default:B(()=>[o(b)]),_:1}),o(k)])}}});export{z as __pageData,N as default};
