import{l as h}from"./chunks/map.965815c3.js";import{d as b,h as k,j as w,o as B,c as m,_ as g,C,H as r,w as d,k as s,a as l}from"./chunks/framework.bec6ef87.js";const G=b({__name:"6.区域模式.md.demo.8e7f9b72",setup(A){const e=k();w(async()=>{await E(e.value)});async function E(a){const o=await h(),n=new o.Map(a,{enableDblclickZoom:!0,enableMapClick:!1,displayOptions:{building:!1},enableRotate:!1,enableTilt:!1}),M=new o.Point(104.10663034748738,24.714727851308414);n.centerAndZoom(M,11),n.enableScrollWheelZoom(!0),new o.Boundary().get("师宗",function(y){for(let p=0;p<y.boundaries.length;p++){const i=y.boundaries[p].split(";"),t=[];for(let c=0;c<i.length;c++){const F=i[c].split(","),_=new o.Point(F[0],F[1]);t.push(_)}const D=new o.MapMask(t,{isBuildingMask:!0,isPoiMask:!0,isMapMask:!0,showRegion:"inside",topFillColor:"#5679ea",topFillOpacity:.5,sideFillColor:"#5679ea",sideFillOpacity:.9});n.addOverlay(D);const f=new o.Polyline(t,{strokeColor:"#4ca7a2",strokeWeight:3,strokeOpacity:1});n.addOverlay(f)}const u=new o.Marker3D(new o.Point(104.10663034748738,24.714727851308414),1e3,{size:50,shape:"BMAP_SHAPE_CIRCLE",fillColor:"#454399",fillOpacity:.6});n.addOverlay(u),n.addOverlay(new o.Marker3D(new o.Point(104.00021214529644,24.836091208203417),Math.round(Math.random())*6e3,{size:50,icon:new o.Icon("https://img1.baidu.com/it/u=2399966577,1808536528&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=492",new o.Size(30,50))}))})}return(a,o)=>(B(),m("div",{id:"container",class:"container",ref_key:"container",ref:e},null,512))}});const L=g(G,[["__scopeId","data-v-31cfc50e"]]),v=s("h1",{id:"区域模式",tabindex:"-1"},[l("区域模式 "),s("a",{class:"header-anchor",href:"#区域模式","aria-label":'Permalink to "区域模式"'},"​")],-1),P=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
