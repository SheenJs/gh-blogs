import{_ as s,c as n,o as a,Q as l}from"./chunks/framework.2601ba03.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"ghui/搭建组件库流程.md","filePath":"ghui/搭建组件库流程.md"}'),p={name:"ghui/搭建组件库流程.md"},o=l(`<h2 id="组件库编写目录" tabindex="-1">组件库编写目录 <a class="header-anchor" href="#组件库编写目录" aria-label="Permalink to &quot;组件库编写目录&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">|</span><span style="color:#B392F0;">--</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">components&#39;,           </span></span>
