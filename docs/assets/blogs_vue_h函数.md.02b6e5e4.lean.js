...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),cs=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"blogs/vue/h函数.md","filePath":"blogs/vue/h函数.md"}'),ls={name:"blogs/vue/h函数.md"},ts=Object.assign(ls,{setup(a){return(o,e)=>{const n=D("demo");return r(),E("div",null,[z,c(n,{customClass:"",sourceCode:`<template>
  <div id="ele"></div>
</template>
...
<\/script>
`},{highlight:p(()=>[ss]),default:p(()=>[c(Q)]),_:1})])}}});export{cs as __pageData,ts as default};
