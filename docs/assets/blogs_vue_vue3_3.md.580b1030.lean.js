import{d as y,C as m,o as r,c as E,H as o,w as p,a as l,F as u,b,y as v,k as s,t as d,h as g,ai as C,aj as h,ak as D,a2 as A,a3 as f,_ as B,Q as F}from"./chunks/framework.bec6ef87.js";import{a as _}from"./chunks/axios.21b846bc.js";const k=y({__name:"DefineEmits",emits:["change","update"],setup(e,{emit:n}){return(c,a)=>{const t=m("a-button");return r(),E(u,null,[o(t,{onClick:a[0]||(a[0]=i=>n("change",666))},{default:p(()=>[l("按钮")]),_:1}),o(t,{onClick:a[1]||(a[1]=i=>n("update",666,7777,"哈哈哈"))},{default:p(()=>[l("按钮")]),_:1})],64)}}}),x=y({__name:"vue3_3.md.demo.7a10cf10",setup(e){const n=a=>{console.log(a)},c=(a,t,i)=>{console.log(a,t,i)};return(a,t)=>(r(),b(k,{onChange:n,onUpdate:c}))}}),q=y({__name:"ReactiveProps",props:{name:{},age:{}},setup(e){return v(()=>{console.log(e.name,e.age)}),(n,c)=>(r(),E(u,null,[s("div",null,d(n.name),1),s("div",null,d(n.age),1)],64))}}),P=y({__name:"vue3_3.md.demo.7a10cf0e",setup(e){const n=g({name:1,age:18}),c=()=>{n.value={name:Math.random(),age:Math.random()}};return(a,t)=>{const i=m("a-button");return r(),E(u,null,[o(i,{onClick:c},{default:p(()=>[l("change")]),_:1}),o(q,C(h(n.value)),null,16)],64)}}}),M={__name:"DefineModel",props:{modelValue:{}},emits:["update:modelValue"],setup(e){const n=D(e,"modelValue");return(c,a)=>A((r(),E("input",{"onUpdate:modelValue":a[0]||(a[0]=t=>n.value=t)},null,512)),[[f,n.value]])}},T=y({__name:"vue3_3.md.demo.7a10cf0c",setup(e){const n=g("");return(c,a)=>(r(),E(u,null,[s("div",null,d(n.value),1),o(M,{modelValue:n.value,"onUpdate:modelValue":a[0]||(a[0]=t=>n.value=t)},null,8,["modelValue"])],64))}});const V=B(T,[["__scopeId","data-v-e51330e2"]]),R={class:"test"},S=y({__name:"vue3_3.md.demo.7a10cf0a",setup(e){return _({url:"/api/tutorials",method:"post",data:{title:"15451",description:"6666"}}).then(n=>{console.log(n)}),(n,c)=>(r(),E("div",R))}}),I=F("",10),w=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
